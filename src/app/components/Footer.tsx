          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12 text-center md:text-left">
            ...
            <div className="mb-6 md:mb-0">
              ...
              <p className="text-sm text-gray-400">
                We are a company dedicated to providing high-quality solutions
                and exceptional service. Our mission is to make a positive
                impact on the world.
              </p>
            </div>
            ...
            <div className="flex justify-center space-x-4 mt-4">
              ...
              >
                <svg
                  ...
                  aria-hidden="true"
                >
                  <path d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm3.333 7.846h-2.146v-1.12c0-.44.205-.658.658-.658h1.493V6.25h-1.637c-1.884 0-2.833 1.13-2.833 2.833v1.763h-1.5v2.146h1.5v5.354h2.146v-5.354h1.792l.25-2.146z" />
                </svg>
              </a>
              <a
                href="#"
